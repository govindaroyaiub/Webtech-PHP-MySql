...
<body>
    <div section id="home_section">
        <ul>
            ...
            <li><a href="ticket.booking.php">Tickets</a>
            </li>
				...
				<div class="banners">
					...
					<div class="grid_4">
						...
						<div class="banner">
							...
							<img src="dhaka.jpg" alt="">
							<div class="label">
								<div class="title">DHAKA</div>
								<div class="price"><span></span></div>
								<a href="Dhaka/Dhaka.php">HOTELS</a>
							</div>
						</div>
					</div>
					<div class="grid_4">
						<div class="banner">
							<img src="khulna.jpg" alt="">
							<div class="label">
								<div class="title">khulna</div>
								<div class="price"><span></span></div>
								<a href="Khulna/khulna.php">HOTELS</a>
							</div>
						</div>
					</div>
					<div class="grid_4">
						<div class="banner">
							<img src="raj.jpg" alt="">
							<div class="label">
								<div class="title">rajshahi</div>
								<div class="price"><span></span></div>
								<a href="rajshahi/Rajshahi.php">HOTELS</a>
							</div>
						</div>
					</div>
					<div class="clear"></div>
					<div class="grid_4">
						<div class="banner">
							...
							<div class="label">
								<div class="title">sylhet</div>
								<div class="price"><span></span></div>
								<a href="Sylhet/Sylhet.php">HOTELS</a>
							</div>
						</div>
					</div>
					<div class="grid_4">
						<div class="banner">
							<img src="chit.jpg" alt="">
							<div class="label">
								<div class="title">chittagong</div>
								<div class="price"><span></span></div>
								<a href="Coxsbazar/CoxsBazar.php">HOTELS</a>
							</div>
						</div>
					</div>
